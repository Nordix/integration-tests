...
func (s *Suite) SetupSuite() {
	...
	r.Run(`[[ ! -z $KUBECONFIG3 ]]`)
	r.Run(`export KUBECONFIG=$KUBECONFIG1`)
	r.Run(`kubectl apply -k ../../../../../../../../../../../../home/ljkiraly/work/code/src/github.com/Nordix/nsm-deployments-k8s/examples/interdomain/spire/cluster1`)
	...
	r.Run(`kubectl apply -k ../../../../../../../../../../../../home/ljkiraly/work/code/src/github.com/Nordix/nsm-deployments-k8s/examples/interdomain/spire/cluster2`)
	r.Run(`kubectl wait -n spire --timeout=1m --for=condition=ready pod -l app=spire-agent`)
	r.Run(`kubectl wait -n spire --timeout=1m --for=condition=ready pod -l app=spire-server`)
	r.Run(`export KUBECONFIG=$KUBECONFIG3`)
	r.Run(`kubectl apply -k ../../../../../../../../../../../../home/ljkiraly/work/code/src/github.com/Nordix/nsm-deployments-k8s/examples/interdomain/spire/cluster3`)
	r.Run(`kubectl wait -n spire --timeout=1m --for=condition=ready pod -l app=spire-agent`)
	r.Run(`kubectl wait -n spire --timeout=1m --for=condition=ready pod -l app=spire-server`)
