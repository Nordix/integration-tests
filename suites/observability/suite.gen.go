...
func (s *Suite) TestJaeger_and_prometheus() {
	...
	r.Run(`kubectl apply -k ../../../../../../../../../../../../home/ljkiraly/work/code/src/github.com/Nordix/nsm-deployments-k8s/examples/observability/jaeger-and-prometheus`)
	r.Run(`kubectl wait -n observability --timeout=1m --for=condition=ready pod -l app=opentelemetry`)
	r.Run(`kubectl create ns nsm-system`)
	r.Run(`kubectl apply -k ../../../../../../../../../../../../home/ljkiraly/work/code/src/github.com/Nordix/nsm-deployments-k8s/examples/observability/jaeger-and-prometheus/nsm-system`)
